...
describe('Normaleezie', function () {
    ...
    describe('when calling denormalize with a serialized normalized array', function () {
    ...
    describe('when calling denormalize with a normalized array', function () {
    ...
    describe('when calling denormalize with a normalized array of books', function () {
